...
function custom_post_services() {
    ...
    register_post_type( 'service', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
        ...
        array( 'labels' => array(
            'name' => __( 'Services', 'sage' ), /* This is the Title of the Group */
            'singular_name' => __( 'Service', 'sage' ), /* This is the individual type */
            'all_items' => __( 'All Services', 'sage' ), /* the all items menu item */
            'add_new' => __( 'Add New', 'sage' ), /* The add new menu item */
            'add_new_item' => __( 'Add New Service', 'sage' ), /* Add New Display Title */
            'edit' => __( 'Edit', 'sage' ), /* Edit Dialog */
            'edit_item' => __( 'Edit Service', 'sage' ), /* Edit Display Title */
            'new_item' => __( 'New Service', 'sage' ), /* New Display Title */
            'view_item' => __( 'View Service', 'sage' ), /* View Display Title */
            'search_items' => __( 'Search Service', 'sage' ), /* Search Custom Type Title */
            ...
            'description' => __( 'Reference Services', 'sage' ), /* Custom Type Description */
            'public' => true,
