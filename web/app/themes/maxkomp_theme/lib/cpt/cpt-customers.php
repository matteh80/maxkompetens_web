...
function custom_post_customers() {
    ...
    register_post_type( 'faq', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
        ...
        array( 'labels' => array(
            ...
            'singular_name' => __( 'Customer', 'sage' ), /* This is the individual type */
            'all_items' => __( 'All Customers', 'sage' ), /* the all items menu item */
            'add_new' => __( 'Add New', 'sage' ), /* The add new menu item */
            'add_new_item' => __( 'Add New Customer', 'sage' ), /* Add New Display Title */
            'edit' => __( 'Edit', 'sage' ), /* Edit Dialog */
            'edit_item' => __( 'Edit Customer', 'sage' ), /* Edit Display Title */
            'new_item' => __( 'New Customer', 'sage' ), /* New Display Title */
            'view_item' => __( 'View Customer', 'sage' ), /* View Display Title */
            'search_items' => __( 'Search Customer', 'sage' ), /* Search Custom Type Title */
            ...
            'description' => __( 'Reference Customers', 'sage' ), /* Custom Type Description */
            'public' => true,
...
add_action( 'init', 'custom_post_customers');
